            ...
            <div class="flex items-center lg:space-x-2">
                ...
                <div data-popover id="popover-deleverto" role="tooltip"
                    ...
                    <div class="p-3">
                        ...
                        <label for="select_address_country" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            language</label>
                        ...
                        <input type="text" id="small-input" placeholder="Enter ZIP or postal code" class="block w-full p-2 mt-2 h-[30px] text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div data-popover id="popover-system-language-currency" role="tooltip"
                    ...
                    <div class="p-3">
                        ...
                        <label for="select_languages" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            language</label>
                        ...
                        <label for="select_currency" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            currency</label>
